...
def baner():
    print('\033[33m\33[1m ●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬● \033[0m ')
    print('\033[32m\33[1m ░░░░░░░░░░░░ ДОБРО ПОЖАЛОВАТЬ В ИГРУ ░░░░░░░░░░░░ \033[0m')
    print('\033[33m\33[1m ●▬▬▬▬▬▬▬▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬▬▬▬▬▬▬▬▬● \033[0m')
...
def play():
    input('Нажмите Enter для входа в игру.')
...
def chooseGun():
    print('\n\nПеред боем с драконом вам нужно выбрать \033[35m\33[1mэкипировку\033[0m и \033[35m\33[1mоружие\033[0m')
...
def chooseEquip():
    print('\n\nВыберите \033[35m\33[1mэкипировку\033[0m: ')
    print('''
...
def fight():
    # global dropDrakon, dropPlayer
    global HPplayer, HPdrakon
    # global DamageMomemtPlayer, DamageMomemtDrakon
    time.sleep(delay)
    print('\n\nНачинается битва. Первый удар наносит дракон')
    time.sleep(delay - 1 if delay - 1 >= 0 else 0.1)
    while True:
        if HPdrakon <= 0:
            ...
            if selectGun != 2:
                ...
                print(
                    f'Дракон сносит вам \033[31m\33[1m{DamageMomemtDrakon}\033[0m хп. У вас остаётся \033[32m\33[1m{HPplayer}\033[0m хп')
                ...
                time.sleep(2)
                print(
                    f'Cносите дракону \033[32m\33[1m{DamageMomemtPlayer}\033[0m хп. У дракона остаётся \033[31m\33[1m{HPdrakon}\033[0m х')
                if HPdrakon <= 0:
                    print("Поздравляю! Вы победили дракона")
                    break
            else:
                ...
                if chance != 1:
                    ...
                    DamageMomemtPlayer = dropPlayer * DamagePlayer
                    print(
                        f'Попадаете нанося дракону урон в \033[32m\33[1m{DamageMomemtPlayer}\033[0m хп. У дракона остаётся \033[31m\33[1m{HPdrakon}\033[0m х')
                else:
...
def refresh():
    global DamageDrakon, DamagePlayer
    global HPplayer, HPdrakon
    HPdrakon = 100.0
    HPplayer = 100.0
    DamageDrakon = 7.0
